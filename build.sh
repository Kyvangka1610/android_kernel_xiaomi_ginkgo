...
export KBUILD_COMPILER_STRING=$(/home/kyvangka1610/kernel/clang-r383902c/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
LD_LIBRARY_PATH=/home/kyvangka1610/kernel/clang-r383902c/lib:/home/kyvangka1610/kernel/clang-r383902c/lib64:$LD_LIBRARY_PATH
...
export OBJCOPY=/home/kyvangka1610/kernel/clang-r383902c/bin/llvm-objcopy
export OBJDUMP=/home/kyvangka1610/kernel/clang-r383902c/bin/llvm-objdump
export STRIP=/home/kyvangka1610/kernel/clang-r383902c/bin/llvm-strip
